...
#if defined (CFG_SECURE_DATA_STORAGE)
    #define SECURE_DATA_STORAGE                         1
#else
    #define SECURE_DATA_STORAGE                         0
#endif /* CFG_SECURE_DATA_STORAGE */
...
#if defined(CFG_UART_FLOW_CTRL_WAKEUP)
#define UART_FLOW_CTRL_WAKEUP                           1
#else
#define UART_FLOW_CTRL_WAKEUP                           0
#endif
...
#if defined (CFG_ONE_WIRE_COEX)
#define WLAN_COEX_ONE_WIRE                              1
#endif
#else
#define WLAN_COEX_ENABLED                               0
#define WLAN_COEX_ONE_WIRE                              0
#endif
 ...
 ****************************************************************************************
 */
void ext_wakeup_enable(uint32_t port, uint32_t pin, uint8_t polarity, ext_wakeup_cb_t cb);
