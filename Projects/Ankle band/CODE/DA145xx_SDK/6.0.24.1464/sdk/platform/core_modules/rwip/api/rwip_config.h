...
enum KE_TASK_TYPE
{
    ...
    #define TASK_FSP_EXT        TASK_RFU_2
#endif
...
enum KE_API_ID
{
    ...
    TASK_ID_CGMS         = 69, // Continuous Glucose Monitoring Service Server Task
    TASK_ID_CGMC         = 70, // Continuous Glucose Monitoring Service Client Task

    TASK_ID_PLXS         = 67,   // Pulse Oximeter Service Server Task
    TASK_ID_PLXC         = 68,   // Pulse Oximeter Service Client Task

    TASK_ID_FSP_EXT      = 0xA0, // Renesas FSP Task
