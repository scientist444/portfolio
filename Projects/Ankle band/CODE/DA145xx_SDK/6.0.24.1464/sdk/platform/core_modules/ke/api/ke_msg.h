...
#if defined (CFG_EXT_APP)
#undef KE_MSG_ALLOC
#define KE_MSG_ALLOC(id, dest, src, param_str)      EXT_APP_KE_MSG_ALLOC(id, dest, src, param_str)
#endif
 ...
 *
 * @param[in] msg parameter structure pointer
 ****************************************************************************************
 */
#define KE_MSG_FREE(msg) ke_msg_free(msg)
#if defined (CFG_EXT_APP)
#undef KE_MSG_FREE
#define KE_MSG_FREE(msg)      EXT_APP_KE_MSG_FREE(msg)
#endif
...
#if defined (CFG_EXT_APP)
#undef KE_MSG_ALLOC_DYN
#define KE_MSG_ALLOC_DYN(id, dest, src, param_str,length)      EXT_APP_KE_MSG_ALLOC_DYN(id, dest, src, param_str,length)
#endif
...
#define KE_MSG_SEND(msg)      ke_msg_send(msg)
#if defined (CFG_EXT_APP)
#undef KE_MSG_SEND
#define KE_MSG_SEND(msg)      EXT_APP_KE_MSG_SEND(msg)
#endif
...
#define KE_MSG_SEND_BASIC(msg_id, dest_id, src_id)      ke_msg_send_basic(msg_id, dest_id, src_id)
#if defined (CFG_EXT_APP)
#undef KE_MSG_SEND_BASIC
#define KE_MSG_SEND_BASIC(msg_id, dest_id, src_id)      EXT_APP_KE_MSG_SEND_BASIC(msg_id, dest_id, src_id)
#endif
...
#define KE_MSG_FORWARD(msg, dest_id, src_id)      ke_msg_forward(msg, dest_id, src_id)
#if defined (CFG_EXT_APP)
#undef KE_MSG_FORWARD
#define KE_MSG_FORWARD(msg, dest_id, src_id)      EXT_APP_KE_MSG_FORWARD(msg, dest_id, src_id)
#endif
