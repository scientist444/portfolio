...
enum {
    /// DCDC nominal voltage level 1.1V (DA14535: By default it is 1.2V in BUCK mode)
 ...
 * @note DA14535: In BUCK mode the DCDC nominal voltage is by default 1.2V instead of 1.1V
 *       when POWER_LEVEL_REG.DCDC_LEVEL equals to 0
 ****************************************************************************************
 */
