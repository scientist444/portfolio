...
#define WKUPCT_PIN_SELECT(port, pin) ( 1U << ( port == GPIO_PORT_0 && pin < GPIO_PIN_END ? pin :        \
                                               -1                                                       \
                                             )                                                          \
                                     )
#else
 ...
 */
#if defined (__DA14531__)
#define WKUPCT_PIN_POLARITY(port, pin, polarity) ( (polarity) << ( port == GPIO_PORT_0 && pin < GPIO_PIN_END ? pin :          \
                                                                   -1                                                        \
                                                                 )                                                           \
                                                 )
#else
