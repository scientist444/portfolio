...
/**
 ****************************************************************************************
 * @brief Create an empty GAPM_START_SCAN_CMD message (scan start message).
 * @return The pointer to the created message.
 * @note Not applicable to DA14531-01
 ****************************************************************************************
 */
__STATIC_FORCEINLINE struct gapm_start_scan_cmd* app_start_scan_msg_create(void)
{
...
/**
 ****************************************************************************************
 * @brief Send a GAPM_START_SCAN_CMD message (scan start message).
 * @param[in] cmd    Pointer to the GAPM_START_SCAN_CMD message to send.
 * @note Not applicable to DA14531-01
 ****************************************************************************************
 */
__STATIC_FORCEINLINE  void app_start_scan_msg_send(struct gapm_start_scan_cmd* cmd)
{
    KE_MSG_SEND(cmd);
}
