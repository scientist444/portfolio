...
enum {
    ...
    ATT_CHAR_PLX_SPOT_MEAS                      = ATT_UUID_16(0x2A5E),
    /// PLX Continuous Measurement
    ATT_CHAR_PLX_CONT_MEAS                      = ATT_UUID_16(0x2A5F),
    /// PLX Features
    ATT_CHAR_PLX_FEAT                           = ATT_UUID_16(0x2A60),
    /// CP Measurement
    ...
    /// CGM Feature
    ATT_CHAR_CGM_FEATURE                        = ATT_UUID_16(0x2AA8),
    /// CGM Status
    ATT_CHAR_CGM_STATUS                         = ATT_UUID_16(0x2AA9),
    /// CGM Session Start Time
    ATT_CHAR_CGM_SESSION_START_TIME             = ATT_UUID_16(0x2AAA),
    /// CGM Session Run Time
    ATT_CHAR_CGM_SESSION_RUN_TIME               = ATT_UUID_16(0x2AAB),
    /// CGM Specific Ops Control Point
    ATT_CHAR_CGM_SPECIFIC_OPS_CP                = ATT_UUID_16(0x2AAC),
