...
enum
{
    ...
    SUOTAR_IMG_VERSION_STR_ERR      = 0x17,     // Invalid image version string format
    SUOTAR_IMG_VERSION_ROLLBACK_ERR = 0x18,     // Image version anti-rollback protection error
    SUOTAR_LOCKED_ERR               = 0x19,     // SUOTA has ended and locked, device should reboot to apply the new image
};
