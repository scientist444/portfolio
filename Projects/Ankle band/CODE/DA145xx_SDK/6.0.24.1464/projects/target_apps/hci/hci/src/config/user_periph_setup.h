...
typedef enum
{
    SEL_UART_BAUDRATE_2400,
    SEL_UART_BAUDRATE_4800,
    SEL_UART_BAUDRATE_9600,
    SEL_UART_BAUDRATE_14400,
    SEL_UART_BAUDRATE_19200,
    SEL_UART_BAUDRATE_28800,
    SEL_UART_BAUDRATE_38400,
    SEL_UART_BAUDRATE_57600,
    SEL_UART_BAUDRATE_115200,
    SEL_UART_BAUDRATE_230400,
    SEL_UART_BAUDRATE_460800,
    SEL_UART_BAUDRATE_500000,
    SEL_UART_BAUDRATE_921600,
    SEL_UART_BAUDRATE_1000000,
} SEL_UART_BAUDRATE;

/// HCI baudrate configuration structure
typedef struct {
    uint8_t hci_baudrate_config_tag[8];
    SEL_UART_BAUDRATE hci_baudrate;
} hci_baudrate_config_t;

typedef union {
    hci_baudrate_config_t config;
    uint8_t config_array[16];
} hci_uart_baud_config_u;
